...
const TRANSACTION_SOURCE_LABEL: &str = "Tx Source";
#[cfg(not(any(target_os = "nanosplus", target_os = "nanox")))]
const TRANSACTION_SOURCE_LABEL: &str = "Transaction Source";

#[cfg(any(target_os = "nanosplus", target_os = "nanox"))]
const NESTED_AUTHORIZATION_LABEL: &str = "Nested Authz";
#[cfg(not(any(target_os = "nanosplus", target_os = "nanox")))]
const NESTED_AUTHORIZATION_LABEL: &str = "Nested Authorization";
...
impl SettingId {
    ...
    /// Returns the localized name/description pair displayed in the settings UI.
    pub fn setting_info(self) -> (&'static str, &'static str) {
        match self {
            ...
            SettingId::TransactionSource => {
                (TRANSACTION_SOURCE_LABEL, "Always show transaction source")
            }
